...
INSERT INTO obat (id, nama_obat, kategori) VALUES
(1, 'Paracetamol', 'Analgesik/Antipiretik'),
(2, 'Amoxicillin', 'Antibiotik'),
(3, 'Antasida', 'Antasida'),
(4, 'Captopril', 'Antihipertensi ACE Inhibitor'),
(5, 'Allopurinol', 'Antihiperurisemia');
